...
const EVENTS_DATA: EventItem[] = [
  {
    id: "ob-fitness-challenge-2026",
    title: "OB Fitness Challenge 2026",
    subtitle: "Are you the strongest? Compete & win OB Fitness premium gear",
    ...
    location: "OB Fitness Center & SmartFit Portal",
    host: {
      name: "OB Fitness Coaching Crew",
      role: "Elite Performance Coaches",
    ...
    description: "Compete in physical challenges (push-ups, pull-ups, planks, deadlifts) to win premium gear and prizes. Track reps live with our AI camera!",
    tags: ["OB Fitness", "Leaderboard", "Elite Gear"],
  },
  {
