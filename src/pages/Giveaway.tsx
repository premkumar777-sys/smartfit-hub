  ...
  return (
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 pt-24 pb-20 space-y-16">
        ...
        {/* Main Prize Showcase Banner */}
        <motion.div 
          className="relative rounded-3xl overflow-hidden border border-primary/30 bg-black/40 backdrop-blur-md p-1"
          style={{ boxShadow: "0 0 50px rgba(0, 180, 255, 0.15)" }}
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.6, delay: 0.25 }}
        >
          <div className="absolute top-4 left-4 z-20 px-3.5 py-1.5 rounded-full bg-primary text-white text-xs font-bold uppercase tracking-wider shadow-lg">
            🎁 Official Prize Bundle
          </div>
          <div className="relative aspect-[16/10] md:aspect-[16/9] w-full rounded-2xl overflow-hidden bg-zinc-950">
            <img 
              src="/prizes.png" 
              alt="SmartFit Custom T-Shirt and Matte Black Gym Shaker" 
