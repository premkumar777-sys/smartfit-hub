    ...
    <div className="min-h-screen py-16 relative overflow-hidden bg-[#0A0A0A]">
      ...
      <Container className="relative z-10 max-w-5xl">
        ...
        <div className="flex flex-col gap-12">
          <PremiumLock
            title="Unlock Advanced Nutrition"
            description="Get AI-powered food intelligence, precision macro tracking, and personalized meal protocols."
            features={[
              "AI conversational food intelligence",
              "Precision Metabolic Calculations",
