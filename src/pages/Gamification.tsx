    ...
    return (
        <div className="min-h-screen py-16 relative overflow-hidden">
            ...
            <Container className="relative z-10">
                ...
                <PremiumLock
                    title="Unlock Rewards & XP"
                    description="Access the full gamification system, unlock legendary achievements, and claim Pro-only rewards."
                    features={[
                        "Exclusive Achievement Badges",
                        "Pro-Level XP Multipliers",
